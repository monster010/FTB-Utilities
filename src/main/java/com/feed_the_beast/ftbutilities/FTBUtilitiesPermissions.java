...
public class FTBUtilitiesPermissions
{
	...
	public static void registerConfigs(RegisterRankConfigEvent event)
	{
		...
		event.register(HOMES_MAX, new ConfigInt(10, 0, 30000), new ConfigInt(100));
		event.register(HOMES_COOLDOWN, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(WARPS_COOLDOWN, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(TPA_COOLDOWN, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(SPAWN_COOLDOWN, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(BACK_COOLDOWN, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(RTP_COOLDOWN, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(HOMES_WARMUP, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(WARPS_WARMUP, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(TPA_WARMUP, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(SPAWN_WARMUP, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(BACK_WARMUP, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(RTP_WARMUP, new ConfigTimer(Ticks.NO_TICKS), new ConfigTimer(Ticks.NO_TICKS));
		event.register(CLAIMS_MAX_CHUNKS, new ConfigInt(500, 0, 30000), new ConfigInt(1000));
		event.register(CHUNKLOADER_MAX_CHUNKS, new ConfigInt(100, 0, 30000), new ConfigInt(200));
